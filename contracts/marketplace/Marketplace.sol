    ...
    ERC721Upgradeable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerableUpgradeable, IERC165Upgradeable,ERC721Upgradeable)
        returns (bool)
    {
        return
    ...
    //////////////////////////////////////////////////////////////*/
    function mint(uint256 _supply,string memory _hash,uint256 _amount) public {

        if(_supply==1){
            _mint(msg.sender,totalSupply);
            settokenURI(totalSupply,_hash);
                    }

        else{
            
            _mint(msg.sender,idcount,_amount,"");
             idcount+=1;
             set_uri(idcount,_hash);
